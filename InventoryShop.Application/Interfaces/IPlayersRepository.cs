...
public interface IPlayersRepository
{
   ...
   Task<PlayerEntity?> GetPlayerByNickname(string nickname, CancellationToken ct);
   Task<List<PlayerEntity>> GetAllPlayersAsync(CancellationToken ct);
   Task<bool> IsNicknameTakenAsync(string nickname, CancellationToken ct);
   Task<bool> IsPasswordTakenAsync(string password, CancellationToken ct);
